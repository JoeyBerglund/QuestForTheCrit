...
public class PlayerMovement : MonoBehaviour
{
    ...
    private Vector3 velocity;             // Store player velocity
    ...
    private void Jump()
    {
        ...
        velocity.y = Mathf.Sqrt(jumpHeight * -2f * Physics.gravity.y); // Using the physics gravity value
    }
    ...
    private void ApplyGravity()
    {
        ...
        {
            velocity.y = 0f; // Prevent downward velocity when on the ground
        }
